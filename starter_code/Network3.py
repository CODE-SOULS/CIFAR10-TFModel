...
class MyNetwork(object):
    ...
    def build_network(self):
        ...
        x = self.conv_block(inputs, num_filters=32, dropout_rate=0.2)
        x = self.conv_block(x, num_filters=64, dropout_rate=0.3)
        x = self.conv_block(x, num_filters=128, dropout_rate=0.4)
